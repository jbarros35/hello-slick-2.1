...
object HelloSlick extends App {
  ...
  db.withSession { implicit session =>
    ...
    val coffeesInsertResult: Option[Int] = coffees ++= Seq (
      ("Colombian",         101, 7.99, 0, 0, new DateTime(2017, 12, 1, 10, 0, 0, 0)),
      ("French_Roast",       49, 8.99, 0, 0, new DateTime(2017, 12, 5, 20, 0, 0, 0)),
      ("Espresso",          150, 9.99, 0, 0, new DateTime(2017, 12, 10, 22, 0, 0, 0)),
      ("Colombian_Decaf",   101, 8.99, 0, 0, new DateTime(2017, 12, 15, 23, 0, 0, 0)),
      ("French_Roast_Decaf", 49, 9.99, 0, 0, new DateTime(2017, 12, 20, 1, 0, 0, 0))
    )
    ...
    coffees foreach { case (name, supID, price, sales, total, createDate) =>
      println("  " + name + "\t" + supID + "\t" + price + "\t" + sales + "\t" + total + "\t" + createDate)
    }
    ...
    val filterQuery: Query[Coffees, (String, Int, Double, Int, Int, DateTime), Seq] =
    ...
    val deleteQuery: Query[Coffees,(String, Int, Double, Int, Int, DateTime), Seq] =
    ...
    val sortByPriceQuery: Query[Coffees, (String, Int, Double, Int, Int, DateTime), Seq] =
