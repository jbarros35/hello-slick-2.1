...
class Coffees(tag: Tag)
  extends Table[(String, Int, Double, Int, Int, DateTime)](tag, "COFFEES") {
  ...
  def creationDate : Column[DateTime] = column[DateTime]("CREATION_DATE")
  def * : ProvenShape[(String, Int, Double, Int, Int, DateTime)] =
    (name, supID, price, sales, total, creationDate)
